        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <table class="table-fixed w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="display: none;">{{$producto->idmanga}}</td>
                        ...
                        <td class="border px-4 py-2">
                            <div class="flex justify-center rounded-lg text-lg" role="group">
                                <!-- botón editar -->
                                <a href="{{ route('productos.edit', $producto->idmanga) }}" class="rounded bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4">Editar</a>

                                <!-- botón borrar -->
                                <form action="{{ route('productos.destroy', $producto->idmanga) }}" method="POST" class="formEliminar">
                                    @csrf
                                    @method('DELETE')
